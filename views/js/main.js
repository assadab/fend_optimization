...
var resizePizzas = function(b) {
    ...
    function d(n, l) {
        var f = n.offsetWidth;
        var k = document.getElementById("randomPizzas").offsetWidth;
        var m = f / k;
    ...
    function a(j) {
        for (var h = 0; h < document.getElementsByClassName("randomPizzaContainer").length; h++) {
            var g = d(document.getElementsByClassName("randomPizzaContainer")[h], j);
            var f = (document.getElementsByClassName("randomPizzaContainer")[h].offsetWidth + g) + "px";
            document.getElementsByClassName("randomPizzaContainer")[h].style.width = f
        }
    }
    a(b);
